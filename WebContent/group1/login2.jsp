...
<body class="b">
<div class="lg">
<form action="LoginServlet2" method="POST" onSubmit="return validate(this)">
...
<input name="userid" value="Administrator" class="ur" onfocus="javascript:if(this.value=='Administrator')this.value='';"/>
<input name="userpass" type="password" value="Password" class="pw" onfocus="javascript:if(this.value=='Password')this.value='';" />
...
<td>
<a href="login4.jsp" class="bn" style="text-decoration:none">去注册</a>
</td>
</tr>
<tr>
<td>
<input type="submit" value="点这里登录" class="bn2" />
</td>
